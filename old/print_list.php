...
<br />
	...
	{ 
		if(!empty($std[$k]["A"])) {
			...
			echo "<tr><td colspan='3'><h2>School Name :".$school_name."</h2></td>
					<td colspan='2' align='right'><h2>School Term :".$student_term."
					</h2></td></tr><tr><td colspan='5' align='center'><h2>Standard : ".$k." - A</h2></td></tr>";
			echo $header;
			...
			echo "<tr>";
			echo "<td colspan='3'><h2>Boys :".$maleA."</h2></td>";
			echo "<td colspan='2' align='right'><h2>Girls :".$femaleA."</h2></td>";
			echo "</tr>";
			echo "</table>";
			echo "<table align='center' width'80%'>
					<tr>
						<td width='50%'>Teacher Name : ____________________ </td>
						<td width='50%' align='right'>Contact Number : ____________________ </td>
					</tr>
				</table>";
		...
		if(!empty($std[$k]["B"])) {
			...
			echo "<tr><td colspan='3'><h2>School Name :".$school_name."</h2></td>
					<td colspan='2' align='right'><h2>School Term :".$student_term."
					</h2></td></tr><tr><td colspan='5' align='center'><h2>Standard : ".$k." - B</h2></td></tr>";
		...
		if(!empty($std[$k]["C"])) {
			...
			echo "<tr><td colspan='3'><h2>School Name :".$school_name."</h2></td>
					<td colspan='2' align='right'><h2>School Term :".$student_term."
					</h2></td></tr><tr><td colspan='5' align='center'><h2>Standard : ".$k." - C</h2></td></tr>";
			echo $header;
		...
		if(!empty($std[$k]["D"])) {
			...
			echo "<tr><td colspan='3'><h2>School Name :".$school_name."</h2></td>
					<td colspan='2' align='right'><h2>School Term :".$student_term."
					</h2></td></tr><tr><td colspan='5' align='center'><h2>Standard : ".$k." - D</h2></td></tr>";
			echo $header;
		...
		if(!empty($std[$k]["E"])) {
			...
			echo "<tr><td colspan='3'><h2>School Name :".$school_name."</h2></td>
					<td colspan='2' align='right'><h2>School Term :".$student_term."
					</h2></td></tr><tr><td colspan='5' align='center'><h2>Standard : ".$k." - E</h2></td></tr>";
			echo $header;
