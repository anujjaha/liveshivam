...
?>
	...
	$myfxsr = 1;
		...
		if($value[3] == "1")
		{
            ...
            $stdOne .= "<br>Std: <br>";
            $stdOne .= "<br><span style='font-size:18px;font-weight:bolx;'>"
						. $value[3] ." - ". $value[4]." <br> ".$category." ".$value[9]."</span><br>";
		...
		if($value[3] == "2")
		{
            ...
            $stdTwo .= "<br>Std: <br>";
            $stdTwo .= "<br><span style='font-size:18px;font-weight:bolx;'>"
						. $value[3] ." - ". $value[4]." <br> ".$category." ".$value[9]."</span><br>";
		...
		if($value[3] == "3")
		{
            ...
            $stdThree .= "<br>Std: <br>";
            $stdThree .= "<br><span style='font-size:18px;font-weight:bolx;'>"
						. $value[3] ." - ". $value[4]." <br> ".$category." ".$value[9]."</span><br>";
