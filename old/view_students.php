	...
	for($k=1;$k<13;$k++)
	{
		if(!empty($std[$k]["A"])) {
			...
			foreach($std[$k]["A"] as $myvalA) {
				...
				echo "<td width='20%' style='border:1px solid black;'>".$myvalA[9]."</td>";
		...
		if(!empty($std[$k]["B"])) {
			...
			foreach($std[$k]["B"] as $myvalB) {
				...
				echo "<td width='20%' style='border:1px solid black;'>".$myvalB[9]."</td>";
				echo "<td width='20%' style='border:1px solid black;'>
				<a href='edit_student.php?school_name=".$school_name."&term=".
		...
		if(!empty($std[$k]["C"])) {
			...
			foreach($std[$k]["C"] as $myvalC) {
				...
				echo "<td width='20%' style='border:1px solid black;'>".$myvalC[9]."</td>";
				echo "<td width='20%' style='border:1px solid black;'>
				<a href='edit_student.php?school_name=".$school_name."&term=".
		...
		if(!empty($std[$k]["D"])) {
			...
			foreach($std[$k]["D"] as $myvalD) {
				...
				echo "<td width='20%' style='border:1px solid black;'>".$myvalD[9]."</td>";
				echo "<td width='20%' style='border:1px solid black;'>
				<a href='edit_student.php?school_name=".$school_name."&term=".
		...
		if(!empty($std[$k]["E"])) {
			...
			foreach($std[$k]["E"] as $myvalE) {
				...
				echo "<td width='20%' style='border:1px solid black;'>".$myvalE[9]."</td>";
				echo "<td width='20%' style='border:1px solid black;'>
				<a href='edit_student.php?school_name=".$school_name."&term=".
